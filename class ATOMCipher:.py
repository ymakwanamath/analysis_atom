...
class ATOMCipher:
    ...
    def Run_Cipher(self, limit):
        ...
        print(output_stream)
            #print("For t ="+str(t)+"\n")
            #print(z)
        print("Frequency of key i.e. both key filter is ")
        print(freq_key)
        print("Frequency of NFSR i.e. b[89] is ")
        print(freq_nlfr)
        print("Frequency of Z function i.e. output keystream is")
        print(freq_z)
        print("Frequency of count only")
        print(freq_cnt_only)
        print("mean is")
